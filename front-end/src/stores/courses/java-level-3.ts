...
const JAVA_LEVEL_3_ORIGINAL_MEDIA = [
	"aj_1_chatbot.mp4",
...
**Evidence target:** The final version can swap or modify one stage without rewriting the whole pipeline, and a short before-and-after explanation names which responsibility moved into each new method or class.`,
		...
		},
		{
			...
			curriculum: [
				{
					title: "Pending Java Level 3 Demo Media",
					content: [
						"The original Java Level 3 source library referenced these demonstration videos. They are reserved on the class static host so the course can link to the same filenames once the files are uploaded.",
						"",
						...JAVA_LEVEL_3_ORIGINAL_MEDIA.map(
							filename =>
