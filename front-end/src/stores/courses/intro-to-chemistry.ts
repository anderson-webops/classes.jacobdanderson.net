...
const REFERENCES = {
	...
	invisibleInkDemo: "https://youtu.be/poCnU_crpjQ",
	iupacPeriodicTable:
		"https://iupac.org/what-we-do/periodic-table-of-elements/",
	javalabDissolution: "https://javalab.org/en/dissolution_process_en/",
	khanWaterCohesion:
	...
	pbsAtomSimulation:
		"https://contrib.pbslearningmedia.org/WGBH/arct15/SimBucket/Simulations/chemthink-atomicstructure/content/index.html",
	pbsPeriodicTable:
		"https://contrib.pbslearningmedia.org/WGBH/conv19/phy03-int-ptable/index.html",
	pbsPeriodicWorksheet:
		"https://mpt.pbslearningmedia.org/asset/phy03_doc_lpachhunt/",
	...
	sodaBalloonDemo: "https://youtu.be/l98vs-JfDPs",
	utAustinBondEnergies:
		"https://gchem.cm.utexas.edu/data/section2.php?target=bond-energies-table4.php",
	volcanoDemo: "https://youtu.be/hBGPE_EZl4w",
	waterTensionDemo: "https://www.youtube.com/watch?v=1p8oHxZtNnw"
} as const;

const PERIODIC_TABLE_REFERENCE_LINKS = [
	`[ACS periodic table](${REFERENCES.acsPeriodicTable})`,
	`[Royal Society of Chemistry periodic table](${REFERENCES.rscPeriodicTable})`,
	`[IUPAC periodic table](${REFERENCES.iupacPeriodicTable})`,
	`[Ptable interactive periodic table](${REFERENCES.ptablePeriodicTable})`
].join(", ");
	...
	modules: [
			...
			curriculum: [
				...
				},
				{
					...
					content: [
						...
						"**Evidence activity:** Set up a chemistry notebook with four recurring sections: observation, particle model, evidence, and claim-evidence-reasoning. Use a simple example such as ice melting, salt dissolving, or a metal object rusting to separate what can be observed from what must be inferred.",
				...
				},
				{
					...
					content: [
						...
						"**Learning path:** Read every number as a measurement package, not just a value. For each example, ask: What quantity is being measured? What unit is attached? How precise is the measurement? Does the answer need a unit conversion? Is the final number more precise than the original data supports? Work slowly enough that units cancel visibly and uncertainty is mentioned before drawing a conclusion.",
						"**Evidence activity:** Compare the measurement tables in the materials pack. Identify which table is easiest to interpret, which table can be repaired by unit conversion, and which table lacks enough context to support a chemistry conclusion. Then classify sample numbers as exact counts, measured values, or converted values so precision is not treated as decoration.",
				...
				},
				{
					...
					content: [
						...
						"**Evidence activity:** Compare a particle diagram, a chemical formula, and a simulation screenshot for the same substance or process. Identify one strength and one limitation of each representation.",
				...
				},
				{
					...
					content: [
						"**Concept path:** Safe chemistry learning separates evidence-based investigation from unnecessary physical risk. Core work in this course uses simulations, diagrams, provided data, public references, and writing so every task can be completed remotely without buying, mixing, heating, tasting, or disposing of materials. Optional household observations are only acceptable when they are simple, safe, and fully replaceable with a non-physical evidence source. A chemistry claim does not need a home experiment to be valid; it needs relevant evidence, clear reasoning, and honest limits on what the evidence can show.",
						"**Learning path:** Treat safety as part of the investigation design. Before starting a task, identify the evidence source, decide whether the evidence can be gathered from a simulation or provided table, and replace any activity involving unknown substances, heat, pressure, ingestion, or disposal with nonphysical evidence. Familiar chemistry phenomena such as water cohesion, lava-lamp density, oobleck, soda gas release, elephant toothpaste, baking-soda volcanoes, invisible ink, and mixture separation remain in the course as case studies or optional observation prompts rather than required home experiments.",
						"**Evidence activity:** Classify sample activities as safe remote work, optional household observation, or not appropriate for this course. Any activity involving heat, ingestion, unknown chemicals, pressure buildup, glassware, or disposal concerns is replaced by a simulation or provided dataset.",
			...
			supplementalProjects: [
				{
					...
					content: [
						...
						"**Requirements:** Use one everyday phenomenon from the course resources. The Everyday Chemistry Observation Log is an equipment-free notebook task: no household experiment is required; a photo, diagram, simulation screenshot, or provided data table is enough. The page explicitly labels what was observed, what was inferred, and what model explains the difference.",
			...
			curriculum: [
				{
					...
					content: [
						...
						"**Learning path:** Sort examples by evidence rather than familiarity. First decide whether the example is matter, then identify whether the description names an object, a material, or a property. Useful evidence includes mass, volume, composition, and measurable properties; weak evidence includes appearance alone or assumptions from everyday use. The lava-lamp density case fits here: oil and water separate because density and particle interactions differ, while gas bubbles can temporarily change what rises or falls.",
						"**Evidence activity:** Sort the matter and classification cards into matter and non-matter, then classify matter examples by observable properties. Use property evidence rather than personal familiarity.",
				...
				},
				{
					...
					content: [
						...
						"**Learning path:** Use a decision tree instead of guessing from appearance. First check whether the composition is fixed; if it is fixed, decide whether the particles contain one element or bonded elements in a fixed ratio. If the composition can vary, classify the sample as a mixture and then decide whether it is uniform throughout. For uncertain examples, write the missing evidence rather than forcing a category.",
						"**Evidence activity:** Classify examples such as oxygen gas, water, salt water, brass, air, carbon dioxide, and trail mix. The key is whether the composition is fixed and whether atoms are bonded into a new substance.",
				...
				},
				{
					...
					content: [
						...
						"**Learning path:** Describe each state with four repeated categories: arrangement, spacing, motion, and attraction. Avoid saying particles are hard, wet, or airy; those are macroscopic descriptions. Instead, translate visible properties into particle behavior, such as fixed shape becoming limited particle movement or gas expansion becoming wide spacing and free motion.",
						"**Investigation:** Use the PhET States of Matter simulation to compare particle motion in a solid, liquid, and gas. Then connect the model to an apple-water-balloon comparison: an apple keeps shape because the solid material holds its particle arrangement, water takes the container shape while staying close together, and air in a balloon spreads through available space while the balloon itself remains a solid material.",
						"**Reasoning focus:** Keep particle identity separate from particle arrangement. Water vapor, liquid water, and ice can all be modeled as the same particles under different conditions. A state change can alter spacing and motion without changing which atoms are present. Oobleck is a useful model-limits case because its behavior changes with force; the point is not to force it into one simple label, but to explain what the state model captures and what it leaves out.",
				...
				},
				{
					...
					content: [
						...
						"**Learning path:** Evaluate changes by asking what evidence shows a new substance. Make a two-column note: visible change on the left and particle-level interpretation on the right. If the only evidence is changed shape, size, state, or distribution, classify the change as physical or uncertain. Only call it chemical when the evidence points to new substances with new particle arrangements.",
						"**Evidence activity:** Compare the physical and chemical change cards. Decide which property changes, what stays chemically the same, and what evidence would be needed before calling the change a reaction.",
				...
				{
					title: "Phenomena Case Library",
					content: [
						"**Concept path:** Familiar demonstrations can make chemistry visible: water cohesion and surface tension, oil-water density movement, oobleck, apples, water, balloons, soda gas release, elephant toothpaste, baking soda volcanoes, invisible ink, and mixture separation. These examples are useful when each one connects a visible observation to a particle-level or evidence-based explanation. The course treats them as equipment-free cases: a diagram, video, data table, or written scenario can provide the evidence when a physical demonstration is not appropriate.",
						"**Learning path:** Choose one case from the library and classify it by chemistry idea. Decide whether the case is mainly about particle arrangement, attractions, density, pressure, dissolving, chemical reaction evidence, gas production, oxidation, or separation. Then write a short explanation that names the visible evidence and the model that explains it.",
						"**Evidence activity:** Use the phenomena case library to build a two-column explanation: visible observation on the left, chemistry model on the right. No materials are required; use the provided case descriptions or a safe reference image/video if available.",
			...
			supplementalProjects: [
				{
					...
					content: [
						...
						"**Requirements:** Write the decision rule before sorting. The Material Sorting Challenge makes the evidence target explicit: every classification needs one evidence sentence. At least two cards are intentionally uncertain so the final product practices saying what evidence is missing instead of guessing.",
				...
				},
				{
					...
					content: [
						"**Project goal:** Use the States of Matter simulation to explain how particle motion changes across states and during heating, cooling, or compression. The final product is a written or visual report using screenshots, sketches, and explanation rather than required recording or live-demo steps.",
						"**Requirements:** Include three screenshots or sketches, one particle-motion comparison, one changed-condition prediction, and one limitation of the simulation. The report compares a solid, liquid, and gas using the same substance when possible so the change in motion and spacing is not confused with changing the identity of the particles. Answer the investigation questions: Can two phases exist at one temperature? What changes when energy is added with the heater? What changes when container volume gets smaller? Which phase is dominant at high temperature and which is dominant at low temperature?",
				...
				{
					title: "Project: Making Oobleck Case Analysis",
					content: [
						"**Project goal:** Analyze oobleck as an equipment-free model-limits case. Oobleck is a familiar non-Newtonian mixture that can feel more solid under sudden force and flow more like a liquid when handled gently.",
				...
				{
					title: "Project: Making a DIY Lava Lamp",
					content: [
						"**Project goal:** Analyze the lava-lamp density case through a diagram or video-backed explanation. The chemistry target is not building a decorative object; it is explaining density, immiscible liquids, gas bubbles, and temporary changes in what rises or sinks.",
			...
			curriculum: [
				{
					...
					content: [
						...
						"**Investigation:** Use the PhET Build an Atom simulation to change protons, neutrons, and electrons separately. Track which changes alter element identity, isotope, mass number, and charge. The PBS/ChemThink atom simulation and atomic-structure sequence can also support reading about vibrating atoms, electron clouds, atomic mass units, and charge before or after using the interactive atom builder.",
				...
				},
				{
					...
					content: [
						...
						"**Evidence activity:** Build a comparison table for alpha, beta-minus, beta-plus, and gamma decay. Include what leaves the nucleus, what changes inside the nucleus, relative travel distance, and one shielding note.",
				...
				},
				{
					...
					content: [
						...
						"**Learning path:** Calculate charge with the rule `protons - electrons`. If the result is positive, the particle is a cation; if negative, it is an anion; if zero, it is neutral. Always identify the element from proton count before calculating charge. This order prevents the mistake of treating electron loss or gain as a change in element identity.",
						"**Evidence activity:** Build neutral atoms and ions from particle counts, then use the ion cards to connect charge to formula writing. For each particle-count example, calculate charge as protons minus electrons.",
				...
				},
				{
					...
					content: [
						...
						"**Learning path:** Decode notation in a fixed order: identify the element symbol, read or infer atomic number, calculate neutrons from mass number minus protons, then calculate electrons from charge. Write each step even when the answer seems obvious. The result is more automatic isotope and ion reasoning without mixing up mass number, atomic mass, and charge.",
						"**Evidence activity:** Translate between notation, particle counts, and plain-language descriptions. Include neutral atoms, positive ions, negative ions, and isotopes from the materials pack.",
			...
			supplementalProjects: [
				{
					...
					content: [
						`**Project goal:** Use the [PBS/ChemThink atomic-structure sequence](${REFERENCES.pbsAtomSimulation}) or the [PhET Build an Atom simulation](${SIMULATIONS.buildAtom}) to explain the parts of an atom and then create a challenge set using particle counts.`,
		...
		},
		{
			...
			curriculum: [
				{
					...
					content: [
						...
						"**Learning path:** Practice reading the table in layers. First read the element box, then locate the element's group and period, then identify its broad region, and finally make one cautious prediction from position. Keep the prediction tied to evidence; table position gives a starting expectation, not a complete description of every property.",
						"**Evidence activity:** Use the ACS periodic table to read element boxes for hydrogen, carbon, oxygen, sodium, chlorine, iron, and neon. Record symbol, atomic number, approximate atomic mass, and one property or use.",
				...
				{
					title: "Periodic Table Reference Set and Symbol Reading",
					content: [
						"**Concept path:** Different periodic-table references present the same element identities with different strengths. A classroom table is useful for a clean first reading, an interactive table is useful for trends and element details, and a standards-focused reference is useful for names, symbols, and atomic-number order. Comparing references helps separate stable facts such as symbol and atomic number from context-dependent details such as property notes, images, history, or examples of use.",
						`**Reference set:** ${PERIODIC_TABLE_REFERENCE_LINKS}. The course also uses the [PBS periodic table interactive](${REFERENCES.pbsPeriodicTable}), [PBS mystery-elements worksheet](${REFERENCES.pbsPeriodicWorksheet}), and [PubChem periodic table](${REFERENCES.pubChemPeriodicTable}). Use ACS as the default classroom reference, RSC for a richer interactive table with trends and element pages, IUPAC for standard names and symbols, Ptable for fast interactive scanning, PBS for guided exploration, and PubChem as an additional element-data reference when it loads correctly.`,
						"**Learning path:** Read one element in at least two references. Confirm the symbol and atomic number first, then compare what extra information each reference adds. If a property description differs in detail, write what each source is emphasizing instead of assuming one table is simply wrong. A compact reading routine checks hydrogen's symbol and atomic number, oxygen's symbol, properties of at least five elements, and one mystery-element clue.",
						"**Symbol activity:** Build a name, initials, or short word from element symbols, then write the full element names and one property note for each element. The point is not only spelling; it is practice reading symbols as real element abbreviations. If a letter such as `Q` cannot be found as a current one-letter symbol, explain that element symbols come from accepted element names and abbreviations rather than from every alphabet letter.",
						"**Output:** A reference-comparison note for two elements and one symbol-built word with full element names and property notes.",
						"**CER checkpoint:** Explain why the periodic table can be both a lookup reference and a prediction tool."
					].join("\n\n"),
					datasetLink: material(
				...
				},
				{
					...
					content: [
						...
						"**Learning path:** Build a labeled map of the table rather than memorizing isolated locations. For each region or group, write one property pattern, one example element, and one caution about overgeneralizing. Then use the map to explain an unfamiliar element by position before checking a reference.",
						"**Evidence activity:** Color-code a blank periodic table by major regions and write one evidence-based property statement for each region.",
				...
				},
				{
					...
					content: [
						...
						"**Learning path:** Compare elements by group before comparing them by name or everyday familiarity. Pick two elements in the same group and explain what valence pattern they likely share. Then pick two elements in different groups and explain how different valence behavior could lead to different ion formation, bonding, or reactivity.",
						"**Evidence activity:** Compare lithium, sodium, and potassium; fluorine, chlorine, and bromine; and helium, neon, and argon. Record what their group position suggests about reactivity.",
				...
				},
				{
					...
					content: [
						...
						"**Evidence activity:** Use the periodic trend mini table to compare two elements. Decide which has a larger atomic radius or stronger attraction for electrons and explain the evidence source.",
			...
			supplementalProjects: [
				...
				},
				{
					...
					content: [
						"**Project goal:** Create an evidence-driven periodic-table challenge using exploration, mystery-element clues, and name-making with element symbols. Each card gives clues such as symbol, atomic number, group, period, region, common use, or trend behavior; the symbol-code portion builds one word or name from valid element symbols.",
			...
			curriculum: [
				{
					...
					content: [
						...
						"**Evidence activity:** Compare sodium chloride, water, oxygen gas, carbon dioxide, and methane from the bonding card set. Identify whether each example is better described by ionic or covalent bonding at an introductory level.",
				...
				},
				{
					...
					content: [
						...
						"**Evidence activity:** Use the ion cards to build neutral formulas such as `NaCl`, `MgCl₂`, `Al₂O₃`, `CaF₂`, and `NH₄NO₃`. Balance total positive and negative charge before writing the formula.",
				...
				},
				{
					...
					content: [
						...
						"**Learning path:** Draw covalent structures as a reasoning process. Count valence electrons, sketch a plausible atom arrangement, add shared pairs as bonds, place remaining electrons as lone pairs, and check whether the drawing is reasonable for the introductory model. After the drawing, state one thing the model shows and one thing it does not show, such as exact bond angles or electron motion.",
						"**Evidence activity:** Sketch simple dot or line structures for `H₂`, `O₂`, `H₂O`, `CO₂`, `CH₄`, and `NH₃`. Count bonds and lone pairs where appropriate.",
				...
				},
				{
					...
					content: [
						...
						[
							"**Common multiple-bond energies from the UT General Chemistry table (kJ/mol):**",
							"| Bond | kJ/mol |",
							"| --- | ---: |",
							"| C=C | 602 |",
							"| C=N | 615 |",
						...
						"**Evidence activity:** Compare `C-C`, `C=C`, and `C≡C`, then compare `O=O` and `N≡N`. State the pattern in bond strength and connect it to why breaking different bonds requires different amounts of energy.",
						"**Worked example:** Breaking one `H-H` bond and one `Cl-Cl` bond uses about `436 + 242 = 678 kJ/mol`. Forming two `H-Cl` bonds releases about `2 × 432 = 864 kJ/mol`, so `ΔH ≈ 678 - 864 = -186 kJ/mol` for the bond-energy estimate.",
				...
				},
				{
					...
					content: [
						...
						"**Learning path:** Decide the naming system before naming the compound. Check whether the formula is ionic, covalent, or includes a polyatomic ion; then apply the matching rules. For each practice item, write both the formula evidence and the naming rule used. This prevents mixing systems, such as using covalent prefixes for a simple ionic compound.",
						"**Evidence activity:** Use the nomenclature practice cards to name compounds and write formulas from names. Include simple ionic examples such as sodium chloride, polyatomic-ion examples such as ammonium nitrate, and covalent examples such as carbon dioxide.",
			...
			curriculum: [
				{
					...
					content: [
						...
						"**Learning path:** Translate every temperature statement into a particle-motion statement, then check whether amount of matter also matters. For comparisons, identify whether the question is about average particle motion or total energy in the sample. This helps avoid the common mistake that hotter always means more total energy.",
						"**Investigation:** Use the States of Matter simulation to compare particle motion before and after heating or cooling. Describe changes in motion without claiming particles themselves get bigger.",
				...
				},
				{
					...
					content: [
						...
						"**Evidence activity:** Compare water, carbon dioxide, ethanol, and a hexane-like oil model using the intermolecular property cards. Then connect the water-cohesion and surface-tension case to attraction evidence: a dome of water on a coin or a bead of water on a surface is visible behavior, while cohesion is the model that explains why nearby water molecules pull together.",
				...
				},
				{
					...
					content: [
						...
						"**Evidence activity:** Read a simplified phase diagram and identify solid, liquid, gas, melting, boiling, and sublimation regions. Compare what changes when pressure increases or temperature decreases.",
				...
				},
				{
					...
					content: [
						...
						"**Investigation:** Use the PhET Gas Properties simulation to compare what happens when temperature, volume, particle amount, or container size changes. Keep one variable controlled when testing another so the pattern is interpretable. The soda-and-balloon activity belongs here as a pressure and gas-release case: carbon dioxide is already dissolved under pressure, and opening the system changes conditions so gas leaves solution and can inflate a balloon in the demonstration version.",
			...
			supplementalProjects: [
				{
					...
					content: [
						...
						"**Requirements:** Label each region, describe particle motion or arrangement, and state where phase changes occur. This can be formatted as a Heating and Cooling Diary using the provided heating-curve data instead of a required physical temperature log. Include at least one sentence explaining why energy transfer can continue while the temperature is flat.",
				...
				},
				{
					...
					content: [
						"**Project goal:** Explain water tension as an equipment-free cohesion and surface-tension case. The central question is why water can form a dome or bead before spilling, and why another liquid such as oil may behave differently.",
		...
		},
		{
			...
			curriculum: [
				{
					...
					content: [
						...
						"**Evidence activity:** Classify the physical and chemical change cards as likely physical change, likely chemical change, or not enough evidence. Include rusting, burning fuel, dissolving sugar, mixing salt and water, a gas-forming reaction diagram, and elephant-toothpaste and baking-soda-volcano cases as diagram or video-based reaction-evidence examples.",
				...
				},
				{
					...
					content: [
						...
						"**Learning path:** Balance equations with a visible atom-count table. Write the unbalanced equation, count each element on both sides, change one coefficient, and recount. Leave subscripts unchanged. When the equation balances, write a final conservation statement explaining how the same atoms appear on both sides in different arrangements.",
						"**Investigation:** Use the PhET Balancing Chemical Equations simulation to balance simple reactions and compare particle, bar chart, and scale views.",
				...
				},
				{
					...
					content: [
						...
						"**Evidence activity:** Sort the reaction type cards by pattern. The goal is pattern recognition and evidence, not advanced prediction rules.",
				...
				},
				{
					...
					content: [
						...
						"**Learning path:** Solve limiting-reactant scenarios by complete product groups. Write the needed ratio, compare the available amounts to that ratio, identify which reactant runs out first, then calculate leftovers. After the analogy makes sense, repeat the same structure with a chemical equation where coefficients supply the ratio.",
						"**Investigation:** Use the PhET Reactants, Products and Leftovers simulation to build sandwich-style analogies and chemical-reaction examples. Record which reactant limits production and what remains.",
			...
			supplementalProjects: [
				...
				{
					title: "Project: Reaction Detective Board",
					content: [
						"**Project goal:** Build an equipment-free reaction-detective evidence board. Include reaction cases such as rusting, combustion, elephant toothpaste, baking soda volcanoes, precipitation, and boiling as a non-reaction comparison.",
				...
				},
				{
					...
					content: [
						"**Project goal:** Use methane combustion and rust formation as anchor examples for chemical reactions. The project distinguishes physical change from chemical reaction, identifies reactants and products, and explains coefficients, subscripts, and state symbols.",
				...
				},
				{
					...
					content: [
						"**Project goal:** Analyze elephant toothpaste as an equipment-free reaction-evidence case. The chemistry target is decomposition of hydrogen peroxide, gas production, catalysis, and foam as trapped oxygen gas.",
				...
				},
				{
					...
					content: [
						"**Project goal:** Analyze vinegar and baking soda as a reaction case about acid-base gas production. The project also makes clear that a classroom volcano model is not the same process as a real lava volcano.",
		...
		},
		{
			...
			curriculum: [
				...
				},
				{
					...
					content: [
						...
						"**Learning path:** Reason with numerator and denominator. For each scenario, mark whether solute amount changes, solution volume changes, or both change. Then decide whether concentration increases, decreases, stays the same, or cannot be determined from the information given. Use saturation language only when there is evidence about the dissolving limit.",
						"**Investigation:** Use the PhET Concentration simulation to change solute amount and solution volume. Watch how color intensity, concentration reading, and saturation state change.",
						"**Reasoning focus:** Concentration is a ratio, so the direction of change depends on both numerator and denominator. Saturation adds a second idea: at a given condition, there may be a maximum amount that dissolves before extra solute remains undissolved. Mixture-separation cases fit here because separation depends on how substances are distributed: rocks and gravel can be separated mechanically, sand and salt can be separated by dissolving and filtering in a model, and saltwater requires removing or evaporating solvent in a diagram-based explanation.",
				...
				},
				{
					...
					content: [
						...
						"**Learning path:** Write molarity as a fraction before calculating: moles of solute over liters of solution. Predict the direction of change before reading or computing the value. If both moles and liters change, compare the ratio rather than assuming the larger number controls the answer.",
						"**Investigation:** Use the PhET Molarity simulation to change moles of solute and liters of solution. Predict whether molarity rises, falls, or stays the same before reading the value.",
			...
			supplementalProjects: [
				...
				{
					title: "Project: Kitchen Chemistry Sort and Separation Map",
					content: [
						"**Project goal:** Build a safe kitchen-chemistry classification and separation map. Use provided descriptions of familiar materials such as salt water, vinegar, sugar water, air, brass, sand-and-salt mixture, oil-and-water mixture, and baking soda solution.",
				...
				},
				{
					...
					content: [
						"**Project goal:** Analyze invisible ink as a solution-and-reaction case. The focus is to distinguish the diluted lemon-juice solution from the later visible change that can occur when the message is revealed.",
				...
				},
				{
					...
					content: [
						"**Project goal:** Use a dissolution simulation to model solutes, solvents, water orientation, and charged particles at the particle level.",
				...
				},
				{
					...
					content: [
						"**Project goal:** Compare hand sorting, filtering, dissolving, and evaporation models as equipment-free mixture-separation methods.",
			...
			curriculum: [
				{
					...
					content: [
						...
						"**Learning path:** Begin with counting analogies, then move to chemistry quantities. Write what is being counted before using the word mole: atoms, molecules, ions, or formula units. Keep the scale idea visible by comparing ordinary counts, dozens, and moles, then explain why chemical formulas and equations need a particle-counting unit.",
						"**Evidence activity:** Compare counting by ones, dozens, pairs, and moles using simplified analogies. Then translate between number of moles and relative particle counts without requiring memorization-heavy calculation first.",
				...
				},
				{
					...
					content: [
						...
						"**Learning path:** Calculate molar mass formula-first. List each element, read its subscript, multiply by the periodic-table mass, add the contributions, and attach `g/mol`. For conversions, set up the unit cancellation before arithmetic so grams-to-moles and moles-to-grams do not get reversed.",
						"**Evidence activity:** Calculate molar masses for `H₂O`, `CO₂`, `NaCl`, `O₂`, and `CaCO₃` using a periodic table and the practice set. Keep units visible at every step.",
				...
				},
				{
					...
					content: [
						...
						"**Learning path:** Highlight the balanced equation before solving. Circle the known substance, underline the target substance, and write the coefficient ratio between them. If the target unit is not moles, do not use the ratio until the known amount has been converted to moles. This keeps formula subscripts, coefficients, and unit conversions in their proper roles.",
						"**Evidence activity:** Read a balanced equation from the practice set and identify all usable mole ratios. Use simple one-step conversions before combining with grams.",
				...
				{
					title: "Limiting Reactants, Leftovers, and Heat Released",
					content: [
						"**Concept path:** A balanced equation can answer three linked questions: which reactant runs out first, how much product forms, and how much energy is released or absorbed when a thermochemical value is supplied. The limiting reactant is decided by the coefficient ratio, not by the largest or smallest starting number. Product amount follows from the limiting reactant, leftovers are unreacted starting material, and reaction heat must be matched to the amount and state of product formed.",
						"**Learning path:** Work in a fixed order:\n\n1. Balance the equation.\n2. Convert given amounts to moles if needed.\n3. Use coefficients to decide the needed ratio.\n4. Identify the limiting reactant.\n5. Calculate product formed and reactant left over.\n6. Apply the heat value only after the product amount and product state are clear.",
						"**Worked example:** Assume hydrogen is `H₂` and oxygen is `O₂`, so the balanced reaction is `2H₂ + O₂ → 2H₂O`. If the starting amounts are `1 mol H₂` and `2 mol O₂`, the balanced ratio requires `2 mol H₂ : 1 mol O₂`. For `1 mol H₂`, only `0.5 mol O₂` is needed. Hydrogen is the limiting reactant. The reaction uses `1 mol H₂` and `0.5 mol O₂`, produces `1 mol H₂O`, and leaves `0 mol H₂` plus `1.5 mol O₂`.",
						"**Heat reasoning:** Forming water from hydrogen and oxygen is exothermic. Using common standard enthalpy values, forming `1 mol` of liquid water releases about `285.8 kJ`, while forming `1 mol` of water vapor releases about `241.8 kJ`. For the worked example, the answer is therefore `1.5 mol O₂` left, `1 mol H₂O` produced, and about `286 kJ` released if liquid water forms. With sign convention, that same heat release can be written as `ΔH ≈ -285.8 kJ` for the produced mole of liquid water.",
						"**Output:** A complete limiting-reactant table with starting moles, moles used, moles left, product formed, product state, and heat released or absorbed.",
						"**CER checkpoint:** Explain why extra oxygen does not produce extra water when hydrogen has already run out."
					].join("\n\n"),
					datasetLink: material(
				...
				},
				{
					...
					content: [
						...
						"**Learning path:** Use a checklist for every quantitative problem: balanced equation, known value, target value, molar mass if grams are involved, mole ratio from coefficients, final unit, and reasonableness. When diagnosing an error, find the first invalid step rather than only marking the final answer wrong. This builds a method that transfers to unfamiliar equations.",
						"**Evidence activity:** Solve two guided problems: one moles-to-moles and one grams-to-grams. Mark the equation, known value, conversion factor, target unit, and final reasonableness check. Then compare with one flawed solution from the error-case table.",
			...
			curriculum: [
				{
					...
					content: [
						...
						"**Learning path:** Separate energy claims from rate claims. Write one sentence about what energy evidence appears, such as heat, light, or cooling, and a separate sentence about how quickly the change occurs. If a factor such as temperature or catalyst is changed, explain whether it affects collision energy, collision frequency, or pathway. When a thermochemical value is supplied, multiply the heat released or absorbed per mole by the moles of product or reactant specified by that value, and state the product state when it matters.",
						"**Evidence activity:** Compare two reaction descriptions from the materials pack: one that is warmed, cooled, or catalyzed, and one that releases heat or light. Identify the evidence for energy transfer, the evidence for rate change, and the limits of the description.",
						"**Worked example:** A glow stick emits light and changes brightness over time. The light is evidence of energy transfer, while the fading brightness is evidence about rate and reactant use. For `2H₂ + O₂ → 2H₂O`, forming liquid water is exothermic; if `1 mol H₂O(l)` forms, about `285.8 kJ` is released, while forming `1 mol H₂O(g)` releases about `241.8 kJ`.",
				...
				},
				{
					...
					content: [
						...
						"**Learning path:** Draw equilibrium as two arrows, not as a stopped process. Label the forward process, reverse process, condition being changed, and expected response. In every example, distinguish the system being at balance from the system being inactive; particles or processes may still be changing even when the measured amount looks constant.",
						"**Evidence activity:** Use the carbonation or saturation evidence seed to build a before/after/changed-condition explanation. Predict what changes when pressure, temperature, concentration, or volume changes.",
				...
				},
				{
					...
					content: [
						...
						"**Learning path:** Track electron ownership explicitly. Identify what substance changes, whether it loses or gains electron density in the simplified model, and what visible evidence shows the change. Use redox language only when electron transfer or charge/oxidation-state change is part of the explanation, not as a generic synonym for reaction.",
						"**Evidence activity:** Read a simple battery or rusting evidence seed. Track which particle or substance loses electron density, which gains it, and how the change can move energy through a system.",
				...
				},
				{
					...
					content: [
						...
						"**Learning path:** Classify advanced questions by what part of matter changes or what evidence is needed. If nuclei change, label the topic nuclear; if carbon structure and functional groups dominate, label it organic; if bulk properties depend on structure and processing, label it materials chemistry. Then name which intro-course tools still help and which deeper tools would be needed next.",
						"**Evidence activity:** Classify example questions as intro chemistry, nuclear chemistry, organic chemistry, materials chemistry, or interdisciplinary. Decide what evidence would be needed to answer each question responsibly.",
			...
			supplementalProjects: [
				{
					...
					content: [
						...
						"**Analysis target:** The card explicitly separates what this course already explains from what a later course would need. For example, a battery card can use redox language and energy transfer, but detailed electrode potentials belong in a deeper chemistry or physics-connected course.",
			...
			curriculum: [
				{
					...
					content: [
						...
						"**Evidence activity:** Compare three possible capstone topics using the evidence seeds. Score each for safety, available evidence, chemistry vocabulary, and scope.",
				...
				},
				{
					...
					content: [
						...
						"**Evidence activity:** Gather or use evidence from the materials pack for the capstone topic. At least one source is a diagram, simulation, or data table; at least one is a written reference.",
				...
				},
				{
					...
					content: [
						...
						"**Evidence activity:** Draft a CER-based capstone explanation. Use course concepts from at least four modules, such as atoms, periodic table, bonding, phase change, reactions, solutions, or stoichiometry.",
				...
				},
				{
					...
					content: [
						...
						"**Evidence activity:** Present the capstone as slides, a short written report, or an annotated notebook page. Revise after feedback by strengthening evidence, clarifying vocabulary, or narrowing the claim.",
			...
			supplementalProjects: [
				{
					...
					content: [
						"**Project goal:** Explain one real-world chemistry phenomenon using course concepts, evidence, and a particle-level model. The showcase requires clear evidence-supported reasoning rather than a broad topic summary.",
						...
						"**Completion checks:** The final artifact is self-contained, evidence-supported, equipment-free, and specific enough to be corrected or challenged."
					].join("\n\n"),
					datasetLink: material("capstone-evidence-seeds"),
					solutionLink: answerKey("capstone-rubric")
				},
				{
					title: "Project: Model Your Own Reaction",
					content: [
						"**Project goal:** Build a focused reaction-modeling capstone. Choose a real-world topic such as food, batteries, sports equipment, medicine, cleaning, corrosion, or environmental chemistry, then narrow it to one chemical reaction or process that can be explained safely with evidence.",
			...
			curriculum: [
				{
					...
					content: [
						...
						`**Resource bank:** Use the ACS Chemistry Guidelines, NIST SI units page, NGSS appendices, OpenStax Chemistry 2e, the local materials pack, the project source index, and this periodic-table reference set: ${PERIODIC_TABLE_REFERENCE_LINKS}.`,
				...
				{
					title: "Periodic Table Reference Set",
					content: [
				...
				},
				{
					...
					content: [
						"**Resource bank:** The course uses PhET simulations for atoms, states of matter, molecule shapes, balancing equations, limiting reactants, concentration, molarity, and pH. It also uses PBS atom simulation, PBS periodic-table interactive, and JavaLab dissolution simulation source links. These simulations provide controlled evidence sources when a physical lab would require materials, supervision, or safety equipment outside the scope of a remote course.",
				...
				{
					title: "Investigation Safety Checklist",
					content: [
						"**Resource bank:** Core work can be completed with a browser, notes, diagrams, screenshots, tables, and writing. Optional household observations are replaceable with provided evidence or simulations.",
					...
					datasetLink: material("investigation-safety-checklist"),
					solutionLink: answerKey("general-cer-rubric")
				},
				{
