			...
			supplementalProjects: [
				{
					...
					content: [
						...
						"**Requirements:** Use one everyday phenomenon from the course resources. The Everyday Chemistry Observation Log is a remote-safe notebook task: no household experiment is required; a photo, diagram, simulation screenshot, or provided data table is enough. The page explicitly labels what was observed, what was inferred, and what model explains the difference.",
		...
		},
		{
			...
			curriculum: [
				...
				},
				{
					...
					content: [
						...
						"**Remote investigation:** Use the PhET States of Matter simulation to compare particle motion in a solid, liquid, and gas. Then connect the model to an apple-water-balloon comparison: an apple keeps shape because the solid material holds its particle arrangement, water takes the container shape while staying close together, and air in a balloon spreads through available space while the balloon itself remains a solid material.",
				...
				},
				{
					...
					content: [
						"**Concept path:** Familiar demonstrations can make chemistry visible: water cohesion and surface tension, oil-water density movement, oobleck, apples, water, balloons, soda gas release, elephant toothpaste, baking soda volcanoes, invisible ink, and mixture separation. These examples are useful when each one connects a visible observation to a particle-level or evidence-based explanation. The course treats them as remote-safe cases: a diagram, video, data table, or written scenario can provide the evidence when a physical demonstration is not appropriate.",
						...
						"**Remote-safe activity:** Use the phenomena case library to build a two-column explanation: visible observation on the left, chemistry model on the right. No materials are required; use the provided case descriptions or a safe reference image/video if available.",
			...
			supplementalProjects: [
				...
				},
				{
					...
					content: [
						"**Project goal:** Analyze oobleck as a remote-safe model-limits case. Oobleck is a familiar non-Newtonian mixture that can feel more solid under sudden force and flow more like a liquid when handled gently.",
			...
			curriculum: [
				...
				},
				{
					...
					content: [
						...
						"**Remote-safe activity:** Compare `C-C`, `C=C`, and `C≡C`, then compare `O=O` and `N≡N`. State the pattern in bond strength and connect it to why breaking different bonds requires different amounts of energy.",
		...
		},
		{
			...
			curriculum: [
				...
				},
				{
					...
					content: [
						...
						"**Remote-safe activity:** Compare water, carbon dioxide, ethanol, and a hexane-like oil model using the intermolecular property cards. Then connect the water-cohesion and surface-tension case to attraction evidence: a dome of water on a coin or a bead of water on a surface is visible behavior, while cohesion is the model that explains why nearby water molecules pull together.",
				...
				},
				{
					...
					content: [
						...
						"**Remote investigation:** Use the PhET Gas Properties simulation to compare what happens when temperature, volume, particle amount, or container size changes. Keep one variable controlled when testing another so the pattern is interpretable. The soda-and-balloon activity belongs here as a pressure and gas-release case: carbon dioxide is already dissolved under pressure, and opening the system changes conditions so gas leaves solution and can inflate a balloon in the demonstration version.",
			...
			supplementalProjects: [
				...
				},
				{
					...
					content: [
						"**Project goal:** Explain water tension as a remote-safe cohesion and surface-tension case. The central question is why water can form a dome or bead before spilling, and why another liquid such as oil may behave differently.",
		...
		},
		{
			...
			supplementalProjects: [
				...
				},
				{
					...
					content: [
						"**Project goal:** Build a remote-safe reaction-detective evidence board. Include reaction cases such as rusting, combustion, elephant toothpaste, baking soda volcanoes, precipitation, and boiling as a non-reaction comparison.",
				...
				},
				{
					...
					content: [
						"**Project goal:** Analyze elephant toothpaste as a remote-safe reaction-evidence case. The chemistry target is decomposition of hydrogen peroxide, gas production, catalysis, and foam as trapped oxygen gas.",
		...
		},
		{
			...
			supplementalProjects: [
				...
				},
				{
					...
					content: [
						"**Project goal:** Compare hand sorting, filtering, dissolving, and evaporation models as remote-safe mixture-separation methods.",
