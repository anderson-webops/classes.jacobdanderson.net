...
function securityLabPurposeText(
	...
	> = {
		...
		"transfer-practice": {
			...
			path: `Move the **${label}** defensive method to a changed fixture, data layout, build flag, or record format so the invariant for ${focus} is tested outside the original example.`
		},
		"extension-practice": {
