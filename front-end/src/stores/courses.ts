...
function normalizeItem(item: RawCourseModuleItem) {
	return {
		...
		modules: [
			{
				...
				curriculum: [
					...
					},
					{
						...
						content: `•  Play a sample Hungry Hippo game.
			...
			},
			{
				...
				curriculum: [
					...
					},
					{
						...
						content: `It’s time to build a fun spinner:
...
**Instructor Note**: Show the solution demo first. Encourage the student to use Motion and Events blocks. Show how to Remix the starter project. Have the student create a Recording Studio Video and share the finished project.`,
					...
					},
					{
						...
						content: `1. When the green flag is clicked, have the ball go to a random position.
...
Have the student record a Recording Studio Video and share their project.`,
					...
					},
					{
						...
						content: `1. When the green flag is clicked, move the dragonfly to a random spot.
			...
			},
			{
				...
				curriculum: [
					...
					},
					{
						...
						content: `1. When the green flag is clicked, send the ball to a random position.
...
Have the student create and share a Recording Studio Video.`,
					...
					},
					{
						...
						content: `1. The up arrow moves the pencil forward; the down arrow moves it backward.
...
Have the student record a Recording Studio Video and share their project.`,
					...
					},
					{
						...
						content: `1. Use the arrow keys to move the beetle 10 steps.
			...
			},
			{
				...
				curriculum: [
					...
					},
					{
						...
						content: `1. When the “1” key is pressed, grow the elephant ten times (increase size by 10, ten times).
...
Have the student record a Recording Studio Video and share their project.`,
					...
					},
					{
						...
						content: `This project uses the Music extension.  When the green flag is clicked, play the song “Hot Cross Buns” twice:
...
Have the student record a Recording Studio Video and share their project.`,
					...
					},
					{
						...
						content: `1. Add an event listener so that when the green flag is clicked, all drawings are erased.
				...
				supplementalProjects: [
					{
						...
						content: `1. Use Pen blocks to draw a hexagon. (Hint: divide 360 degrees by the number of sides.)
			...
			},
			{
				...
				curriculum: [
					...
					},
					{
						...
						content: `1. Make the dinosaur follow the mouse pointer forever.
...
Have the student record a Recording Studio Video and share their project.`,
					...
					},
					{
						...
						content: `1. When the green flag is clicked, make the ball bounce around the screen forever.
...
Have the student record a Recording Studio Video and share their project.`,
					...
					},
					{
						...
						content: `1. Make a magic wand move to the frog and turn it into a wizard.
				...
				supplementalProjects: [
					{
						...
						content: `1. Use event listeners to control the octopus with the arrow keys.
...
3. Add conditionals for yellow, green and red backgrounds.`,
					...
					},
					{
						...
						content: `1. When the green flag is clicked, make the basketball go to Gobo and move forever.
				...
				curriculum: [
					{
						...
						content: `Explain that “if … then … else” allows multiple outcomes. Discuss real-life examples of decisions with two possible results. Introduce the “if … then … else” block and demonstrate how it can be used to choose between two actions.`,
						projectLink:
					...
					},
					{
						...
						content: `1. Create controls for the dinosaur using the arrow keys.
...
Have the student record a Recording Studio Video and share their project.`,
					...
					},
					{
						...
						content: `1. When the green flag is clicked, use if/then blocks to control the dinosaur with the arrow keys.
				...
				supplementalProjects: [
					{
						...
						content: `1. When the green flag is clicked, start the rocketship at the center bottom of the stage.
...
3. When the rocketship reaches the star, make it blast off using sounds, motion or visual effects.`,
					...
					},
					{
						...
						content: `1. When the green flag is clicked, make the baby fish continuously go to the mouse pointer.
			...
			},
			{
				...
				curriculum: [
					...
					},
					{
						...
						content: `1. When the “1” key is pressed, have Gobo ask a math question (e.g., “What’s 9 – 7?”). Indicate whether the answer is correct or incorrect via costume, sound or speech.
...
**Instructor Note**: Emphasize asking forever until the correct answer is given and mention nested conditionals (putting one conditional inside another).`,
					...
					},
					{
						...
						content: `1. When the green flag is clicked, play an introduction and ask the user their name.
...
Challenge: Add more fortunes and questions to make the fortune teller more detailed.`,
					...
					},
					{
						...
						content: `1. When the green flag is clicked, have the sprite choose a random number between 1 and 20.
				...
				supplementalProjects: [
					{
						...
						content: `1. Ask the user if they want to build a shop, plant a tree or explore the island.
...
5. Encourage the user to explore and discover secrets.`,
					...
					},
					{
						...
						content: `1. Ask the user for their name and call them “Captain”.
			...
			},
			{
				...
				curriculum: [
					...
					},
					{
						...
						content: `1. When the green flag is clicked, make the praying mantis appear at a random position.
...
5. End the game when the timer runs out and display the score.`,
					...
					},
					{
						...
						content: `1. Set up two sprites: a person and a slice of cake.
...
5. Add a timer that counts down and ends the game when it reaches zero.`,
					...
					},
					{
						...
						content: `1. Choose three performers (sprites).
				...
				supplementalProjects: [
					{
						...
						content: `1. Use the arrow keys to move a sprite to each quadrant of the stage.
...
3. Challenge: Add shapes or obstacles that must be avoided.`,
					...
					},
					{
						...
						content: `1. Using the Pen extension, draw a picture by moving the sprite to various X and Y coordinates.
			...
			},
			{
				...
				curriculum: [
					...
					},
					{
						...
						content: `1. When the green flag is clicked, create a timer variable and set it to 20.
...
5. Encourage the student to add a high-score variable.`,
					...
					},
					{
						...
						content: `1. When the green flag is clicked, have spiders appear at random positions and move downward.
				...
				supplementalProjects: [
					{
						...
						content: `1. Use the arrow keys to move a sprite around the stage.
...
4. Challenge: Add obstacles and a goal to reach.`,
					...
					},
					{
						...
						content: `1. Control a crab with the arrow keys.
...
3. Add a timer; when time runs out, end the game and display how much food was collected.`,
					...
					},
					{
						...
						content: `1. Start with a variable “money” set to 10.
...
Have the student record a Recording Studio Video and share the project.`,
					...
					},
					{
						...
						content: `Let’s make a game where you control a bowl and try to collect various items!
...
3. Make your story come to life! Broadcast messages between your sprites to make sure everything happens in the correct sequence.`,
					...
					},
					{
						...
						content: `Pick a partner for Dani to play with, and they will bounce around the screen together!
				...
				curriculum: [
					{
						...
						content: `Let’s put our skills to the test! Let’s use what we’ve learned in the course to build this Hedgehog Race game.
				...
				supplementalProjects: [
					{
						...
						content: `Have your student play through the demo and identify the different elements of the game that they will have to program in order to create this game. Helpful questions include: what does each sprite do? How do we control it? How does each sprite react to certain events? What variables do we need to keep track of? How does the game end?
...
Challenge: Can you add another sprite that moves around using the W-A-S-D keys?`
					...
					},
					{
						...
						content: `1. When 1 is pressed, have Gobo ask a question like “What’s 3 − 7?” After the user answers, Gobo should change its costume, make a sound and/or say something to indicate whether the answer is correct or incorrect.
			...
			},
			{
				...
				curriculum: [
					...
					},
					{
						...
						content: `1. Open the Jackson Pollock project from Scratch Level 1 and click “See Inside”.
...
**Instructor Note**: Show the demo first to illustrate what nested loops do. Encourage students to experiment with different color and size values.`,
					...
					},
					{
						...
						content: `1. Use nested loops and the Pen extension to draw a series of triangles that increase in size to form a pyramid shape.
				...
				supplementalProjects: [
					{
						...
						content: `1. Program a pitcher sprite to pitch the ball when the green flag is clicked.
...
5. Challenge: Add fielders that move to catch the ball.`,
					...
					},
					{
						...
						content: `1. Use nested loops to draw a grid of squares on the stage.
...
3. Challenge: Color the squares randomly or create a checkerboard pattern.`,
					...
					},
					{
						...
						content: `1. Use a repeat loop to create a spiral pattern.
			...
			},
			{
				...
				curriculum: [
					...
					},
					{
						...
						content: `1. Program the cat sprite to move around the stage using the arrow keys.
...
**Instructor Note**: Discuss ordering of conditions. If more than one condition is true, decide which message should appear first.`,
					...
					},
					{
						...
						content: `1. Use a broadcast message to start the strength tester.
				...
				supplementalProjects: [
					{
						...
						content: `1. Move the baby chick with the arrow keys.
...
5. Challenge: Add an egg that the chick must protect.`,
					...
					},
					{
						...
						content: `1. When the green flag is clicked, broadcast a message to start the game.
			...
			},
			{
				...
				curriculum: [
					...
					},
					{
						...
						content: `1. Use a pencil sprite as the parent.
...
Encourage the student to record a video and share the project.`,
					...
					},
					{
						...
						content: `1. Program an umbrella controlled by the arrow keys.
				...
				supplementalProjects: [
					{
						...
						content: `1. Move the parrot using the arrow keys.
			...
			},
			{
				...
				curriculum: [
					...
					},
					{
						...
						content: `1. Ask the user for their name and respond with a greeting.
...
Encourage the student to record and share the project.`,
					...
					},
					{
						...
						content: `1. When the key 1 is pressed, ask the user to type a word and then spell all of its letters.
				...
				supplementalProjects: [
					{
						...
						content: `1. Ask the user for the name of a country, its leader and what the country is known for.
...
3. Challenge: Use one say block with multiple join blocks to create the sentence.`,
					...
					},
					{
						...
						content: `1. Store a secret word using a variable or list.
			...
			},
			{
				...
				curriculum: [
					...
					},
					{
						...
						content: `1. Ask the user for two numbers and which operation to perform (add, subtract, multiply or divide).
...
**Instructor Note**: Encourage the student to add more operations and test different inputs.`,
					...
					},
					{
						...
						content: `1. Have a butterfly count from 1 to 50.
				...
				supplementalProjects: [
					{
						...
						content: `1. Ask the user what number they want to practice multiples of.
...
5. Challenge: Ask the user how many multiples they want to recite.`,
					...
					},
					{
						...
						content: `1. Ask the user for an x-coordinate.
			...
			},
			{
				...
				curriculum: [
					...
					},
					{
						...
						content: `1. Ask the user for five things they want to do in their lifetime.
...
**Instructor Note**: Use loops to iterate through the list.`,
					...
					},
					{
						...
						content: `1. When the spacebar is pressed, ask the user for a number and add it to a list.
...
**Instructor Note**: Encourage the student to think of additional list manipulations.`,
					...
					},
					{
						...
						content: `1. Create two lists: one for the correct sequence of notes and one for the player’s guesses.
				...
				supplementalProjects: [
					{
						...
						content: `1. Choose a random number between 1 and 10.
...
6. Challenge: Add a timer to see how many correct multiples the player can enter in a certain amount of time.`,
					...
					},
					{
						...
						content: `1. Create a list of words (your word bank).
...
Use inputs for each function and then call the functions from the main script.`,
					...
					},
					{
						...
						content: `1. Decide on several “talents” for a sprite to perform (such as playing a song, dancing or spinning).
				...
				supplementalProjects: [
					{
						...
						content: `Write the following functions:
...
4. A function that says the first 10 multiples of a number (or a user-specified number of multiples).`,
					...
					},
					{
						...
						content: `1. Create a function called get computer answer that returns a random choice from a list of rock, paper and scissors.
