...
async function updateEmail() {
        ...
        if (!props.entityId || !props.role) {
                emailError.value = "Missing account information.";
                return;
        }
...
async function updatePassword() {
        ...
        if (!props.entityId || !props.role) {
                passwordError.value = "Missing account information.";
                return;
        }
...
<template>
        ...
        <section v-if="showSecurity" class="security-card">
