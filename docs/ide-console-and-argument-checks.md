...
and input. Expanding keeps the program, output, and input intact. Click console
...
The browser regression test covers six IDE modes at four viewport sizes, console
